...
public class GdxSetup {
	...
	public void build (ProjectBuilder builder, String outputDir, String appName, String packageName, String mainClass,
		...
		project.files.add(new ProjectFile("core/src/screen/base/BaseScreen", "core/src/" + packageDir + "/screen/base/BaseScreen.java", true));
		project.files.add(new ProjectFile("core/src/screen/base/ScreenManager", "core/src/" + packageDir + "/screen/base/ScreenManager.java", true));
		...
		if (builder.modules.contains(ProjectType.ANDROID)) {
			...
			project.files.add(new ProjectFile("android/proguard-android.txt", false));
